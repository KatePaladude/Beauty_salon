...
<?php
	...
	if(isset($_POST['do']) && $_POST['do'] == "Add")
	{
        ...
        {
            $data['alert'] = "Помилка";
            $data['message'] = "Ця категорія вже створена!";
        ...
        elseif($checkItem == 0)
        {
            ...
            $data['alert'] = "Успіх";
            $data['message'] = "Нова категорія була успішно створена!";
            echo json_encode($data);
            exit();
        }
    ...
    if(isset($_POST['action']) && $_POST['action'] == "Edit")
	{
        ...
        {
            $data['alert'] = "Помилка";
            $data['message'] = "Ця категорія вже існує!";
            echo json_encode($data);
            exit();
        }
        elseif($checkItem == 0)
        {
            ...
            try
            {
                ...
                $data['alert'] = "Успіх";
                $data['message'] = "Назва категорії успушно оновлена!";
                echo json_encode($data);
                exit();
            }
            catch(Exception $e)
