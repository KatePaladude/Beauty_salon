...
?>
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Послуги</h1>
            </div>
            ...
            <?php
                ...
                ?>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Послуги</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Категорія послуги</th>
                                        <th scope="col">Опис послуги</th>
                                                ...
                                                echo "<td>";
                                                    ...
                                                    ?>
                                                        <ul class="list-inline m-0">
                                                            ...
                                                            <li class="list-inline-item" data-toggle="tooltip" title="Видалити">
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="exampleModalLabel">Видалити послугу</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                Ви впевнені, що хочете видалити цю послугу? "<?php echo $service['service_name']; ?>"?
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Відмінити</button>
                                                                                <button type="button" data-id = "<?php echo $service['service_id']; ?>" class="btn btn-danger delete_service_bttn">Видалити</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                ...
                elseif($do == 'Add')
                {
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Додати нову послугу</h6>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="services.php?do=Add">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['service_name']))?htmlspecialchars($_POST['service_name']):'' ?>" placeholder="Назва послуги" name="service_name">
                                            <?php
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        ?>
                                        <div class="form-group">
                                            <label for="service_category">Категорія послуги</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="service_duration">Тривалість послуги (хв)</label>
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['service_duration']))?htmlspecialchars($_POST['service_duration']):'' ?>" placeholder="Тривалість послуги" name="service_duration">
                                            <?php
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="service_price">Ціна послуги (₴)</label>
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['service_price']))?htmlspecialchars($_POST['service_price']):'' ?>" placeholder="Ціна послуги" name="service_price">
                                            <?php
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="service_description">Опис послуги</label>
                                            ...
                                            <?php
                                                ...
                                                if(isset($_POST['add_new_service']))
                                                {
                                                    ...
                                                    elseif(strlen(test_input($_POST['service_description'])) > 250)
                                                    {
                                                        ?>
                                                            <div class="invalid-feedback" style="display: block;">
                                                                Довжина опису не повинна перевищувати 250 літер.
                                                            </div>
                                                        <?php
                                ...
                                <button type="submit" name="add_new_service" class="btn btn-primary">Додати послугу</button>
                                    ...
                                    try
                                    {
                                        ...
                                        ?>
                                            <script type="text/javascript">
                                                swal("Нова послуга","Нову послугу було успішно створено", "success").then((value) =>
                                                {
                ...
                elseif($do == "Edit")
                {
                    ...
                    if($service_id)
                    {
                        ...
                        if($count > 0)
                        {
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Змінити Послугу</h6>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="services.php?do=Edit&service_id=<?php echo $service_id; ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="service_name">Назва послуги</label>
                                                    <input type="text" class="form-control" value="<?php echo $service['service_name'] ?>" placeholder="Назва послуги" name="service_name">
                                                    <?php
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="service_duration">Тривалість послуги (хв)</label>
                                                    <input type="text" class="form-control" value="<?php echo $service['service_duration'] ?>" placeholder="Тривалість послуги" name="service_duration">
                                                    <?php
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="service_price">Ціна послуги (₴)</label>
                                                    <input type="text" class="form-control" value="<?php echo $service['service_price'] ?>" placeholder="Ціна послуги" name="service_price">
                                                    <?php
                                        ...
                                        <button type="submit" name="edit_service_sbmt" class="btn btn-primary">Зберегти зміни</button>
                                    </form>
